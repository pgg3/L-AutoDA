...
class HopSkipJumpAttack(MinimizationAttack):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        x_advs, num_bin_search = self._binary_search(is_adversarial, originals, x_advs)
        total_num_queries += num_bin_search
        ...
        for step in range(self.steps):
            ...
            total_num_queries += num_gradient_estimation_steps
            ...
            if self.stepsize_search == "geometric_progression":
                ...
                total_num_queries += num_geo_search
                ...
                for epsilons in epsilons_grid:
                    ...
                    x_advs_proposals, num_bin_search = self._binary_search(
                ...
                total_num_queries += num_eps_search
            ...
            if self.max_queries is not None and total_num_queries > self.max_queries:
